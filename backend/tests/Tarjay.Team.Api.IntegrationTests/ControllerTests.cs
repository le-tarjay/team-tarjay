...
public class ControllerTests : IClassFixture<ApiWebApplicationFactory>
{
    ...
    public async Task GetWeatherForecast()
    {
        ...
        // to send none and pass; that it would now fail unchanged is the change working. The
        // no-token case it used to cover by accident belongs to ProtectedEndpointTests, which
